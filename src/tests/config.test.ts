...
describe('ConfigService — YAML round-trip', () => {
  ...
  it('preserves traffic pattern — spike', () => {
    ...
    const params = imported.producer.traffic.params as SpikeParams;
  ...
  it('preserves traffic pattern — steady', () => {
    ...
    assert.equal((imported.producer.traffic.params as SteadyParams).rps, 500);
  });
...
describe('ConfigService — step traffic YAML', () => {
  it('exports and imports step traffic', () => {
    ...
    const steps = (imported.producer.traffic.params as StepParams).steps;
...
describe('ConfigService — custom traffic YAML', () => {
  it('exports and imports custom series', () => {
    ...
    const series = (imported.producer.traffic.params as CustomParams).series;
