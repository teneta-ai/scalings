...
import { SimulationResult, TickSnapshot } from '../interfaces/types.js';
...
export class ChartRenderer {
  ...
  private playbackSpeed: number = 5;
  ...
  private animate(snapshots: TickSnapshot[]): void {
        ...
        scales: {
          ...
          y: {
            ...
            ticks: {
              ...
              maxTicksLimit: 4,
              callback: (val: number) => val >= 1000 ? `${(val / 1000).toFixed(0)}k` : val,
            },
